...
<!-- form start  -->
              ...
              <form action="{{url('/custom_order')}}" method="POST">
                @csrf
                <div class="row mb-3">
                  <div class="col-6">
                    <div class="form-group">
                      <label class="text-black" for="fname">Weight (lbs)</label>
                      <input type="text" class="form-control" id="fname" name="weight">
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="form-group">
                      <label class="text-black" for="lname">Height (cm)</label>
                      <input type="text" class="form-control" id="lname" name="height">
                    </div>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-4">
                    <div class="form-group">
                      <label class="text-black" for="fname">Shoulder (inches)</label>
                      <input type="text" class="form-control" id="fname" name="shoulder">
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="form-group">
                      <label class="text-black" for="lname">Bust (inches)</label>
                      <input type="text" class="form-control" id="lname" name="bust">
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="form-group">
                      <label class="text-black" for="lname">Waist (inches)</label>
                      <input type="text" class="form-control" id="lname" name="waist">
                    </div>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-4">
                    <div class="form-group">
                      <label class="text-black" for="fname">Hips (inches)</label>
                      <input type="text" class="form-control" id="fname" name="hips">
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="form-group">
                      <label class="text-black" for="lname">Thigh (inches)</label>
                      <input type="text" class="form-control" id="lname" name="thigh">
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="form-group">
                      <label class="text-black" for="lname">Leg Opening (inches)</label>
                      <input type="text" class="form-control" id="lname" name="leg">
                    </div>
                  </div>
                </div>
                <div class="form-group mb-3">
                  <label class="text-black" for="email">Contact Phone Number</label>
                  <input type="tel" class="form-control" id="" placeholder="Enter Your Number" name="phone">
                </div>


                <div class="editorreply form-group mb-5 ">
                    <label class="text-black" for="message" >Description</label>
                    <textarea class="form-control" id="editor" name="desc" cols="30" rows="5"></textarea>
                ...
                <button type="submit" class="btn btn-primary-hover-outline">Send Order</button>
              </form>
