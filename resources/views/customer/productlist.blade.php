...
<div class="hero">
        ...
        @foreach($product as $data)
            @if($count % 3 == 0) <!-- Check if the count is a multiple of 3 to start a new row -->
                <div class="row">
            @endif
            ...
            @if($count % 3 == 0 || $loop->last) <!-- Check if the count is a multiple of 3 or it's the last item to close the row -->
                </div>
            @endif
        @endforeach
    </div>
		...
		{{ $product->onEachSide(6)->links('vendor.pagination.bootstrap-5') }}
